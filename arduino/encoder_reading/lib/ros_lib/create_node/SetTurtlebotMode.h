...
static const char SETTURTLEBOTMODE[] = "create_node/SetTurtlebotMode";
  ...
  class SetTurtlebotModeRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return SETTURTLEBOTMODE; };
    virtual const char * getMD5() override { return "89b81386720be1cd0ce7a3953fcd1b19"; };
  ...
  class SetTurtlebotModeResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return SETTURTLEBOTMODE; };
    virtual const char * getMD5() override { return "ef9db56bf4a60ce42049595d58c32b54"; };
