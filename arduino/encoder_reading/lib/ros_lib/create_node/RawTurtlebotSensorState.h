...
namespace create_node
{
  ...
  class RawTurtlebotSensorState : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "create_node/RawTurtlebotSensorState"; };
    virtual const char * getMD5() override { return "103d192c45e953c8bb1c3c046e89e2ff"; };
